        ...
        <div className="row copyright">
          ...
          {/* <div className="text-right col-6">
            <a href="https://www.linkedin.com/in/sahil-patel-93a0972b">
              <img width="30" height="25" src="./assets/img/LI-In-Bug.png" />
            </a>
            <a href="https://github.com/Spatel134">
              <img width="100" height="35" src="./assets/img/GitHub_Logo_White.png" />
            </a>
            <a href="mailto:Patelsahil0789@gmail.com">
              <img width="30" height="30" src="./assets/img/mailButton.png" />
            </a>
          </div> */}
        </div>
      </div>
